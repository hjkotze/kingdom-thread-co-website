// Two corrections to the live Privacy Policy content, per the launch
// readiness audit:
//   1. It named PayFast/Yoco/PayPal as payment processors — none are
//      actually integrated anywhere in this codebase. The real (and, for
//      now, only planned) payment method is manual EFT with a Proof of
//      Payment upload, already described correctly elsewhere in the same
//      document. Disclosing a data-sharing relationship that doesn't
//      exist is itself a POPIA accuracy problem, not just a nice-to-have.
//   2. The stated right to "request the deletion of your account and
//      data" wasn't backed by any concrete process description — this
//      makes explicit that it's a manual, email-initiated request (there
//      is no self-service delete-my-account button), so the promise
//      matches what actually happens today.
// Only overwrites if the content still matches the exact text originally
// seeded by 20260819100001 — if an admin has already hand-edited this
